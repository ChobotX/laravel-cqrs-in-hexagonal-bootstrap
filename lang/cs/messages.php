...
return [
    ...
    'profile' => [
        ...
        'two_factor_title' => 'Dvoufaktorové ověřování',
        'two_factor_subtitle' => 'Nastavte si autentizační aplikaci nebo e-mailové ověření pro svůj účet.',
        'manage_two_factor' => 'Spravovat dvoufaktorové ověřování',
    ...
    'auth' => [
        ...
        'invalid_two_factor_code' => 'Neplatný dvoufaktorový kód.',
        'two_factor_title' => 'Dvoufaktorové ověření',
        'two_factor_subtitle' => 'Zadejte jednorázový kód pro dokončení přihlášení.',
        'send_email_code' => 'Odeslat kód e-mailem',
        'two_factor_method' => 'Metoda ověření',
        'two_factor_code' => 'Ověřovací kód',
        'verify_two_factor' => 'Ověřit',
        'two_factor_code_sent' => 'Ověřovací kód byl odeslán na váš e-mail.',
        'two_factor_email_subject' => 'Váš dvoufaktorový kód',
        'two_factor_email_code' => 'Váš ověřovací kód je :code.',
    ...
    'users' => [
        ...
        'in_team' => 'v týmu',
        'two_factor_reset_section_title' => 'Obnova druhého faktoru',
        'two_factor_reset_section_subtitle' => 'Použijte, když uživatel ztratil přístup k autentizační aplikaci i záložní kódy. Může se znovu přihlásit (pokud to politika povoluje) a musí si 2FA nastavit znovu.',
        'two_factor_reset_action' => 'Resetovat druhý faktor pro tohoto uživatele',
        'two_factor_reset_confirm_title' => 'Resetovat druhý faktor?',
        'two_factor_reset_confirm_message' => 'Tímto se pro uživatele :name vypnou e-mailové OTP i autentizační aplikace. Akci nelze vrátit.',
        'two_factor_reset' => 'Druhý faktor byl pro tohoto uživatele resetován.',
    ],
    ...
    'settings' => [
        ...
        'two_factor_title' => 'Dvoufaktorové ověření',
        'two_factor_intro' => 'Nastavte a vynucujte metody dvoufaktorového ověření.',
        'own_two_factor_intro' => 'Nastavte a spravujte druhý faktor přihlášení pro váš účet.',
        'two_factor_required_for_all' => 'Vyžadovat dvoufaktorové ověření pro všechny uživatele',
        'two_factor_email_method' => 'Povolit e-mail OTP',
        'two_factor_totp_method' => 'Povolit autentizační aplikaci (TOTP)',
        'two_factor_updated' => 'Nastavení dvoufaktoru bylo uloženo.',
        'confirm_totp_setup' => 'Potvrdit kód autentizátoru',
        'cancel_totp_setup' => 'Zrušit nastavení autentizátoru',
        'email_otp_section_title' => 'Jednorázové heslo přes e-mail (OTP)',
        'email_otp_section_subtitle' => 'Použijte jednorázové kódy doručené e-mailem jako druhý faktor.',
        'email_otp_switch_label' => 'Jednorázové kódy e-mailem',
        'email_otp_disabled_by_tenant' => 'Vaše organizace nepovoluje e-mailové OTP pro dvoufaktorové ověření.',
        'totp_section_title' => 'Autentizační aplikace (TOTP)',
        'totp_section_subtitle' => 'Použijte aplikaci pro jednorázová hesla založená na čase jako druhý faktor.',
        'totp_switch_label' => 'Autentizační aplikace',
        'totp_disabled_by_tenant' => 'Vaše organizace nepovoluje autentizační aplikace pro dvoufaktorové ověření.',
        'totp_enabled_active_hint' => 'Autentizační aplikace je zapnutá. Vypněte přepínačem, pokud ji chcete odebrat.',
        'totp_qr_hint' => 'Naskenujte tento QR kód v Google Authenticator, 1Password, Authy nebo jiné TOTP aplikaci.',
        'totp_qr_aria' => 'QR kód pro nastavení autentizátoru',
        'totp_secret_label' => 'Nelze naskenovat QR? Zadejte tento klíč ručně',
        'totp_backup_codes_title' => 'Záložní kódy',
        'totp_backup_codes_instruction' => 'Uložte si tyto jednorázové záložní kódy na bezpečné místo. Budete je potřebovat, pokud ztratíte přístup k autentizační aplikaci.',
        'totp_backup_codes_download' => 'Stáhnout záložní kódy (.txt)',
        'totp_backup_codes_download_required_hint' => 'Než potvrdíte kód z autentizátoru, stáhněte si záložní kódy.',
        'totp_backup_codes_downloaded_ack' => 'Stažení zaznamenáno. Teď můžete potvrdit kód z autentizátoru.',
        'totp_backup_codes_download_required' => 'Před dokončením nastavení autentizátoru si stáhněte záložní kódy.',
        'totp_code_label' => 'Kód z autentizátoru',
        'mail_title' => 'Poskytovatel e-mailu',
        'mail_intro' => 'Nahraďte výchozí SMTP přenos vlastním poskytovatelem, aby pozvánky a obnovy hesel byly odesílány z vaší adresy.',
        'mail_use_custom' => 'Pro tohoto nájemníka použít vlastního poskytovatele e-mailu',
        'mail_default_in_use' => 'E-maily nájemníka jsou aktuálně odesílány přes výchozí přenos platformy.',
        'mail_provider' => 'Poskytovatel',
        'mail_provider_mailpit' => 'Mailpit (lokální vývoj)',
        'mail_provider_mailjet' => 'Mailjet',
        'mail_provider_mailgun' => 'Mailgun',
        'mail_provider_custom' => 'Vlastní SMTP',
        'mail_host' => 'SMTP host',
        'mail_port' => 'SMTP port',
        'mail_encryption' => 'Šifrování',
        'mail_encryption_none' => 'Žádné',
        'mail_username' => 'SMTP uživatelské jméno',
        'mail_password' => 'SMTP heslo / API klíč',
        'mail_password_set_placeholder' => '•••••••• (zachováno)',
        'mail_password_hint' => 'Pro zachování stávajícího hesla nechte prázdné.',
        'mail_from_address' => 'Adresa odesílatele',
        'mail_from_name' => 'Jméno odesílatele',
        'mail_updated' => 'Nastavení poskytovatele e-mailu uloženo.',
        'mail_test_action' => 'Odeslat testovací e-mail',
        'mail_test_hint' => 'Odešle testovací e-mail na vaši adresu pomocí nastavení výše.',
        'mail_test_sent' => 'Testovací e-mail odeslán. Zkontrolujte schránku.',
        'mail_test_failed' => 'Testovací e-mail selhal: :error',
    ],
    ...
    'exceptions' => [
        ...
        'invalid_mail_transport_host' => 'SMTP host nesmí být prázdný.',
        'invalid_mail_transport_port' => 'SMTP port musí být v rozsahu 1 až 65535.',
        'invalid_mail_transport_from_address' => 'Adresa odesílatele musí být platný e-mail.',
        'invalid_mail_transport_from_name' => 'Jméno odesílatele nesmí být prázdné.',
        'invalid_mail_transport_encryption' => 'Šifrování musí být prázdné, "tls" nebo "ssl".',
        'invalid_two_factor_policy_requires_method' => 'Při vynucení dvoufaktoru musí zůstat zapnutá alespoň jedna metoda.',
