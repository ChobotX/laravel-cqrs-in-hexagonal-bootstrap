    ...
    test: {
        ...
        coverage: {
            ...
            exclude: [
                ...
                'resources/js/**/*.vue',
                'resources/js/data-grid/composables/types.ts',
                'resources/js/schema-builder/types.ts',
                ...
                'resources/js/data-grid/pages/users-grid-app.ts',
                'resources/js/data-grid/pages/teams-grid-app.ts',
                'resources/js/data-grid/pages/roles-grid-app.ts',
                'resources/js/data-grid/pages/entries-grid-app.ts',
            ],
            thresholds: {
                autoUpdate: true,
                statements: 100,
