...
use App\Infrastructure\User\LaravelSessionPendingTotpBackupCodesSession;
...
final class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(TwoFactorSettingsRepository::class, EloquentTwoFactorSettingsRepository::class);
        $this->app->bind(UserTwoFactorStateRepository::class, EloquentUserTwoFactorStateRepository::class);
        $this->app->bind(EmailTwoFactorChallengeRepository::class, EloquentEmailTwoFactorChallengeRepository::class);
        $this->app->bind(TwoFactorManager::class, SimpleTwoFactorManager::class);
        $this->app->bind(PendingTotpBackupCodesSession::class, LaravelSessionPendingTotpBackupCodesSession::class);
        $this->app->bind(TwoFactorCodeNotifier::class, LaravelTwoFactorCodeNotifier::class);
