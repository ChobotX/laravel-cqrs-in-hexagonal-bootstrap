...
final readonly class DeprecateDefinitionVersionController
{
    ...
    public function __invoke(string $namespace, string $slug, int $version): RedirectResponse
    {
        ...
        $this->commandBus->dispatch(new DeprecateDefinitionVersionCommand($targetVersion->id->value));

        return redirect()->back()->with('success', __('messages.registry.versions.deprecated'));
    }
