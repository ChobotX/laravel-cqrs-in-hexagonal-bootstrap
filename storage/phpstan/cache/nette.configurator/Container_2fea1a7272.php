...
class Container_2fea1a7272 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_2fea1a7272 $container)
			{
	...
	{
		return new Tests\Architecture\PHPStan\NoStaticCallsInDomainRule;
	}
	...
	public function createServiceContainer(): Container_2fea1a7272
	{
		return $this;
	}
