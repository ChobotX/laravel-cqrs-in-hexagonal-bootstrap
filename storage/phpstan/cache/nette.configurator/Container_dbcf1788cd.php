...
class Container_dbcf1788cd extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService042(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				['identifier' => 'missingType.generics', 'paths' => ['/var/www/html/app/Infrastructure/Bus']],
			],
			true
		);
	}
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_dbcf1788cd $container)
			{
	...
	public function createServiceContainer(): Container_dbcf1788cd
	{
		return $this;
	}
