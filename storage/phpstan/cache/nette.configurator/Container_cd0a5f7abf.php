...
class Container_cd0a5f7abf extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_cd0a5f7abf $container)
			{
	...
	public function createServiceContainer(): Container_cd0a5f7abf
	{
		return $this;
	}
