...
class Container_86c4d9b61f extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_86c4d9b61f $container)
			{
	...
	public function createServiceContainer(): Container_86c4d9b61f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 'max',
			'paths' => ['/var/www/html/app', '/var/www/html/bootstrap', '/var/www/html/tests'],
			'exceptions' => [
				'implicitThrows' => true,
