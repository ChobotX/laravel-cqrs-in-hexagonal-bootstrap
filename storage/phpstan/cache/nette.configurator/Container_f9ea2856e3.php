...
class Container_f9ea2856e3 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService042(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				['identifier' => 'missingType.generics', 'paths' => ['/var/www/html/tests/Unit/Infrastructure/Bus']],
			],
			true
		);
	}
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f9ea2856e3 $container)
			{
	...
	public function createServiceContainer(): Container_f9ea2856e3
	{
		return $this;
	}
