...
class Container_b494802b7b extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b494802b7b $container)
			{
	...
	public function createServiceContainer(): Container_b494802b7b
	{
		return $this;
	}
