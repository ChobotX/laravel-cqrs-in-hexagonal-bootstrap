...
class Container_d80b1a4419 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d80b1a4419 $container)
			{
	...
	public function createServiceContainer(): Container_d80b1a4419
	{
		return $this;
	}
