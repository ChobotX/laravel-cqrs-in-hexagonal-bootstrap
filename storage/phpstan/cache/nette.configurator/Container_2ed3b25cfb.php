...
class Container_2ed3b25cfb extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService04(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => ['/var/www/html/tests/Feature', '/var/www/html/tests/Architecture/PHPStan/Fixture'],
				'analyse' => [],
			]
		);
	}
	...
	public function createService042(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				['identifier' => 'class.notFound', 'paths' => ['/var/www/html/tests/Architecture/PHPStan/Test']],
			],
			true
		);
	}
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_2ed3b25cfb $container)
			{
	...
	public function createServiceContainer(): Container_2ed3b25cfb
	{
		return $this;
	}
