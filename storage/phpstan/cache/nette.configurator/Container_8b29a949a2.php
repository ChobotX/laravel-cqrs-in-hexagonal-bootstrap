...
class Container_8b29a949a2 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					...
					'paths' => ['/var/www/html/app/Infrastructure/Bus', '/var/www/html/tests/Unit/Infrastructure/Bus'],
				],
			],
			true
		);
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8b29a949a2 $container)
			{
	...
	public function createServiceContainer(): Container_8b29a949a2
	{
		return $this;
	}
