...
class Container_be9e6eb8f3 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_be9e6eb8f3 $container)
			{
	...
	public function createServiceContainer(): Container_be9e6eb8f3
	{
		return $this;
	}
