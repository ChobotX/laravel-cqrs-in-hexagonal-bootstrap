...
class Container_a9cd15fd83 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'Tests\Architecture\PHPStan\NoStaticMethodDeclarationsInDomainRule' => [['0969']],
		'Tests\Architecture\PHPStan\NoStaticCallsInDomainRule' => [['0970']],
		'Tests\Architecture\PHPStan\OnlyDomainExceptionsInDomainRule' => [['0971']],
		'Tests\Architecture\PHPStan\UseStrictArgumentsInConsoleRule' => [['0972']],
		'Tests\Architecture\PHPStan\NoCrossDomainDependenciesRule' => [['0973']],
		'Tests\Architecture\PHPStan\NoMixedAnnotationsRule' => [['0974']],
		'Tests\Architecture\PHPStan\NoPhpstanIgnoreRule' => [['0975']],
		'Tests\Architecture\PHPStan\NoMockeryInDomainTestsRule' => [['0976']],
		'Tests\Architecture\PHPStan\UseStrictRouteParametersRule' => [['0977']],
	];
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a9cd15fd83 $container)
			{
	...
	public function createService0969(): Tests\Architecture\PHPStan\NoStaticMethodDeclarationsInDomainRule
	{
		return new Tests\Architecture\PHPStan\NoStaticMethodDeclarationsInDomainRule;
	}


	public function createService0970(): Tests\Architecture\PHPStan\NoStaticCallsInDomainRule
	{
		return new Tests\Architecture\PHPStan\NoStaticCallsInDomainRule;
	}


	public function createService0971(): Tests\Architecture\PHPStan\OnlyDomainExceptionsInDomainRule
	{
		return new Tests\Architecture\PHPStan\OnlyDomainExceptionsInDomainRule;
	}


	public function createService0972(): Tests\Architecture\PHPStan\UseStrictArgumentsInConsoleRule
	{
		return new Tests\Architecture\PHPStan\UseStrictArgumentsInConsoleRule;
	}


	public function createService0973(): Tests\Architecture\PHPStan\NoCrossDomainDependenciesRule
	{
		return new Tests\Architecture\PHPStan\NoCrossDomainDependenciesRule;
	}


	public function createService0974(): Tests\Architecture\PHPStan\NoMixedAnnotationsRule
	{
		return new Tests\Architecture\PHPStan\NoMixedAnnotationsRule;
	}


	public function createService0975(): Tests\Architecture\PHPStan\NoPhpstanIgnoreRule
	{
		return new Tests\Architecture\PHPStan\NoPhpstanIgnoreRule;
	}


	public function createService0976(): Tests\Architecture\PHPStan\NoMockeryInDomainTestsRule
	{
		return new Tests\Architecture\PHPStan\NoMockeryInDomainTestsRule;
	}


	public function createService0977(): Tests\Architecture\PHPStan\UseStrictRouteParametersRule
	{
	...
	public function createServiceContainer(): Container_a9cd15fd83
	{
		return $this;
	}
