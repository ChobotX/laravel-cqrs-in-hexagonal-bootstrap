...
class Container_d23cf4b005 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d23cf4b005 $container)
			{
	...
	public function createServiceContainer(): Container_d23cf4b005
	{
		return $this;
	}
