...
class Container_b2d06505b2 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b2d06505b2 $container)
			{
	...
	public function createServiceContainer(): Container_b2d06505b2
	{
		return $this;
	}
