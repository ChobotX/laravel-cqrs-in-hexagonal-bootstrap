...
class Container_e8a5588fc3 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e8a5588fc3 $container)
			{
	...
	public function createServiceContainer(): Container_e8a5588fc3
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => [['identifier' => 'method.internalClass', 'paths' => ['/var/www/html/tests']]],
