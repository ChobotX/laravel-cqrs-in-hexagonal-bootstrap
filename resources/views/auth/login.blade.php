...
@section('content')
    <h2 class="text-center text-xl font-semibold text-gray-900">{{ __('messages.auth.sign_in_title') }}</h2>
    <p class="mb-6 mt-1 text-center text-base text-gray-500 sm:text-sm">{{ __('messages.auth.sign_in_subtitle') }}</p>
