...
const editor = useEditor({
    content: props.bodyTemplate,
    extensions: [StarterKit, Link.configure({ openOnClick: false }), VariableChipExtension],
});
    ...
    >
        ...
        <div>
            ...
            <div class="rounded-b-lg border border-gray-300">
                <EditorContent
                    :editor="editor"
                    class="prose prose-sm max-w-none px-3 py-2 focus-within:ring-2 focus-within:ring-indigo-600 [&_.ProseMirror]:min-h-[160px] [&_.ProseMirror]:outline-none"
        ...
        >
            ...
            <div class="mt-1 rounded-lg border border-gray-200 bg-white">
                <iframe
                    v-if="previewHtml"
                    :srcdoc="previewHtml"
